...
export const EmailIcon = ({ className = 'w-4 h-4' }: IconProps) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const getSocialIcon = (icon: SocialLink['icon'], className?: string) => {
  const icons = {
...
export const SocialLinks = ({
  ...
  <div className={className}>
    {links.map((link) => (
      ...
      >
        {getSocialIcon(link.icon, iconClassName)}
      </a>
    ))}
  </div>
);
